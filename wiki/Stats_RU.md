...
Если не кликать на костер, а просто нажать горячую клавишу, которая отвечает за открытие и закрывает окно повышение уровня, то вы откроете тоже меню как в костре, но без возможности что либо прокачать, также левая часть окна будет немного изменена: там вы увидите текущие значения различных характеристик персонажа (статус), например здоровья, выносливости, сопротивления и т.д.
